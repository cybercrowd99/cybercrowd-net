...
//
// JOB:
// Receive one valid setup token and one password,
// resolve the permanent identity-active-id,
// seal the user record,
// create one authenticated session,
// consume the setup token,
// and return the next destination.
//
// OWNS:
// Setup-token lookup.
// Setup-record validation.
// identity-active-id continuity.
// Password hashing.
// User-record creation.
// user-email lookup creation.
// Session creation.
// EAT cookie issuance.
...
// Returning-member password verification.
// Dashboard rendering.
//
// ONE ROCK.
// ONE OBJECT.
