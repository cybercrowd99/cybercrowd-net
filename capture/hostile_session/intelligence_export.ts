// capture/hostile_session/intelligence_export.ts
// Capture‑Net: Hostile Session Intelligence Export Organ
...
export class HostileSessionIntelligenceExport {
  ...
  /**
   * Export a hostile-session intelligence package to D1, KV, and R2.
   */
